...
class CheckViolationsCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('repository'    , null, InputOption::VALUE_REQUIRED, 'The GIT repository path', getcwd())
            ...
            ->addOption('with-assets'   , null, InputOption::VALUE_NONE, 'Ignore assets violations(js, css, ..)', null)
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($gitRepository->isBare()) {
            throw new NotFoundGitRepositoryException();
        }
    ...
    {
        return preg_match('/\.(css|js|coffe|less|sass)/i', $filename);
    }
}
